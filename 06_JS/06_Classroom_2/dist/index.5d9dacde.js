...
})({"8ugfB":[function(require,module,exports) {
...
/* index.js */ var _statsJs = require("./stats.js");
...
function render(grades) {
    ...
    tbody.innerHTML = `<tr>
  <td>${(0, _statsJs.getNumberOfGrades)(grades)}</td>
  <td>${(0, _statsJs.getFirstGrade)(grades)}</td>
  <td>${(0, _statsJs.getLastGrade)(grades)}</td>
  </tr>`;
    let tbody2 = document.querySelector("#stats-table2 tbody");
    tbody2.innerHTML = `<tr>
  <td>${(0, _statsJs.isTestTooEasy)(grades)}</td>
  <td>${(0, _statsJs.gradeExists)(grades, Number.parseInt(gradeToCheck.value, 10))}</td>
  <td>${(0, _statsJs.exportCSV)(grades)}</td>
  </tr>`;
}
...
gradesForm.addEventListener("submit", (event)=>{
    ...
    grades = (0, _statsJs.addGrade)(grades, newGrade);
    yourGrade.value = "";
...
},{"./stats.js":"dA1Kv","snackbar":"nwWOh"}],"dA1Kv":[function(require,module,exports) {
/**
 * @param {array} grades
 * @param {number} grade
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addGrade", ()=>addGrade);
/**
 * @param {array} grades
 */ parcelHelpers.export(exports, "getNumberOfGrades", ()=>getNumberOfGrades);
/**
 * @param {array} grades
 */ parcelHelpers.export(exports, "getFirstGrade", ()=>getFirstGrade);
/**
 * @param {array} grades
 */ parcelHelpers.export(exports, "getLastGrade", ()=>getLastGrade);
/**
 * @param {array} grades
 */ parcelHelpers.export(exports, "isTestTooEasy", ()=>isTestTooEasy);
/**
 * @param {array} grades
 * @param {number} grade
 */ parcelHelpers.export(exports, "gradeExists", ()=>gradeExists);
/**
 * @param {array} grades
 */ parcelHelpers.export(exports, "exportCSV", ()=>exportCSV);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"em8QG"}],"em8QG":[function(require,module,exports) {
...
},{}]},["8ugfB","1Z4Rq"], "1Z4Rq", "parcelRequireb79e")
